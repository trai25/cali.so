...
我们运用了 [**Static Route Handler**](https://nextjs.org/docs/app/building-your-application/routing/router-handlers#static-route-handlers) 来生成静态的 `/feed.xml`；

我们运用了 [**Rewrites**](https://nextjs.org/docs/app/api-reference/next-config-js/rewrites) 来实现多路由的重写映射；

我们运用了 [**Metadata**](https://nextjs.org/docs/app/building-your-application/optimizing/metadata) 来为网站添加 RSS Autodiscovery；
